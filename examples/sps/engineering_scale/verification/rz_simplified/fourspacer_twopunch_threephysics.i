...
[Mesh]
  ...
  [six_blocks]
    ...
    inputs = 'top_ram_spacer_block top_sinter_spacer_block top_punch_unified_bottom low_punch_unified_top low_sinter_spacer_block low_ram_spacer_block'
  []
  [block_rename]
    type = RenameBlockGenerator
    input = six_blocks
    old_block = '1 2 3 5 6 7'
    new_block = 'top_ram_spacer top_sinter_spacer top_punch low_punch low_sinter_spacer low_ram_spacer'
  []
...
[AuxKernels]
  [heat_transfer_radiation]
    ...
    boundary = 'top_ram_spacer_right top_sinter_spacer_right top_punch_right low_punch_right low_sinter_spacer_right low_ram_spacer_right'
...
[BCs]
  ...
  [external_surface_temperature]
    ...
    boundary = 'top_ram_spacer_right top_sinter_spacer_right top_punch_right low_punch_right low_sinter_spacer_right low_ram_spacer_right' #purposefully exclude the top_step_right which will be in contact with the die
    variable = temperature
...
[Materials]
  ...
  [graphite_electro_thermal_properties]
    ...
    block = 'top_ram_spacer top_sinter_spacer top_punch low_punch low_sinter_spacer low_ram_spacer top_spacers_secondary_subdomain top_spacer_punch_secondary_subdomain punch_secondary_subdomain low_spacer_punch_secondary_subdomain low_spacers_secondary_subdomain'
  []
[]
