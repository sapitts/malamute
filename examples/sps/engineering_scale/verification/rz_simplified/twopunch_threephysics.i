...
[Mesh]
  ...
  [two_blocks]
    ...
    inputs = 'top_punch_unified_bottom low_punch_unified_top'
  []
  [block_rename]
    type = RenameBlockGenerator
    input = two_blocks
    old_block = '3 5'
    new_block = 'top_punch low_punch'
  []
...
[AuxKernels]
  [heat_transfer_radiation]
    ...
    boundary = 'top_punch_right low_punch_right'
...
[BCs]
  ...
  [fixed_centerline]
    ...
    variable = disp_x
    value = 0
    boundary = 'top_punch_left low_punch_left'
  []
  [temperature_top]
    type = ADDirichletBC
    variable = temperature
  ...
  [external_surface_temperature]
    ...
    boundary = 'top_punch_right low_punch_right' #purposefully exclude the top_step_right which will be in contact with the die
    variable = temperature
...
[Materials]
  ...
  [graphite_electro_thermal_properties]
    ...
    block = 'top_punch low_punch punch_secondary_subdomain'
  []
[]
