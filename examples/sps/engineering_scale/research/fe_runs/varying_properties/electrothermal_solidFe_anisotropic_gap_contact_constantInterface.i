...
[Materials]
  ...
  [iron_electrical_conductivity_powder]
    ...
    block = 'powder'
  []
  [iron_electrical_conductivity_interfaces_powder]
    type = ADGenericConstantMaterial
    ...
    block = 'bottom_punch_powder_secondary_subdomain powder_top_punch_secondary_subdomain inside_powder_secondary_subdomain'
  []
  ...
  [iron_thermal_conductivity_powder]
    ...
    block = 'powder'
  []
  [iron_thermal_conductivity_interfaces_powder]
    type = ADGenericConstantMaterial
