...
sinter_spacer_overhang_radius = 0.0135 ## is less than the 13.55 that actually exists but the modification is necessary to get the mesh to work
...
[Executioner]
  ...
  nl_abs_tol = 1e-9 # couldn't converge past the first timestep on temperature #1e-10
  nl_max_its = 20
  nl_forced_its = 2
  l_max_its = 50
