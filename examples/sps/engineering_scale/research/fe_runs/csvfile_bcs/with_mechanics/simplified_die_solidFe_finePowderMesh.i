...
[Mesh]
  ...
  [ten_blocks]
    ...
    inputs = 'bottom_punch_block powder_block top_punch_block'
  ...
  [block_rename]
    ...
    input = ten_blocks
    old_block = '4 5 6'
    new_block = 'bottom_punch powder top_punch'
...
[Variables]
  [disp_x]
    block = 'bottom_punch powder top_punch'
...
[BCs]
  ...
  [pressure_top_ram]
    ...
    function = 'if(t<100.0, 339.3*t, 3393.12)' # approximated from hydraulic force, with g=9.8067
    extra_vector_tags = 'ref'
  []
  [fixed_centerline]
    type = ADDirichletBC
    variable = disp_x
    value = 0
    boundary = 'bottom_punch_left powder_left top_punch_top'
  []
...
#     temperature = temperature
#     contact_pressure = bottom_ram_cc_normal_lm
...
#     temperature = temperature
#     contact_pressure = bottom_cc_sinter_normal_lm
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = bottom_sinter_punch_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
#     temperature = temperature
#     contact_pressure = bottom_punch_powder_normal_lm
#     primary_hardness = graphite_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = powder_top_punch_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = iron_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = top_punch_sinter_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
#     secondary_conductivity = ccfiber_thermal_conductivity
#     temperature = temperature
#     contact_pressure = top_sinter_cc_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = ccfiber_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = top_cc_ram_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
[Executioner]
  ...
  nl_abs_tol = 1e-10 # couldn't converge past the first timestep on temperature #1e-10
  nl_max_its = 20
  nl_forced_its = 2
  l_max_its = 50
