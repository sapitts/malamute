...
[Functions]
  ...
  [13Nov_dcs5_current]
    type = PiecewiseLinear
    data_file = 'dcs5_13nov23run1_ironPowder.csv'
    y_title = 'DCCurrent_A'
    format = COLUMNS
    scale_factor = ${fparse 1.0/ram_spacer_surface_area}
  []
  [13Nov_dcs5_topRam_temperature]
    type = PiecewiseLinear
    data_file = 'dcs5_13nov23run1_ironPowder.csv'
    y_title = 'OvertempController_C'
    format = COLUMNS
  []
  [13Nov_dcs5_bottomRam_temperature]
    type = PiecewiseLinear
    data_file = 'dcs5_13nov23run1_ironPowder.csv'
  ...
  [top_ram_temperature]
    ...
    symbol_names = 'tempC'
    symbol_values = '13Nov_dcs5_topRam_temperature'
  []
  [bottom_ram_temperature]
    type = ParsedFunction
    expression = 'tempC - 273.15'
    symbol_names = 'tempC'
    symbol_values = '13Nov_dcs5_bottomRam_temperature'
  []
[]
...
[BCs]
  ...
  [electric_top]
    ...
    variable = potential
    function = '13Nov_dcs5_current' #'current_application'
    boundary = 'top_ram_spacer_top'
  []
  [electric_bottom]
    type = ADDirichletBC
