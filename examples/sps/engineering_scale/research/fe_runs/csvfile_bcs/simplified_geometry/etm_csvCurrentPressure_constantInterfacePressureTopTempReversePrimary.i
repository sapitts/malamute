...
[Mesh]
  ...
  patch_update_strategy = always #iteration
...
[Constraints]
  ...
  #   use_displaced_mesh = true
  # []
  # [thermal_contact_interface_inside_die_top_punch_original]
  #   type = ModularGapConductanceConstraint
  ...
  [thermal_contact_interface_inside_die_top_punch]
    ...
    variable = temperature_inside_top_punch_lm
    secondary_variable = temperature
    secondary_boundary = die_wall_left
    secondary_subdomain = inside_die_secondary_subdomain
    primary_subdomain = inside_top_punch_primary_subdomain
    primary_boundary = top_punch_right
    gap_geometry_type = CYLINDER
    # gap_flux_models = 'thermal_conduction_wall_top_punch closed_thermal_interface_inside_die_top_punch'
    gap_flux_models = 'thermal_conduction_wall_top_punch '
    extra_vector_tags = 'ref'
