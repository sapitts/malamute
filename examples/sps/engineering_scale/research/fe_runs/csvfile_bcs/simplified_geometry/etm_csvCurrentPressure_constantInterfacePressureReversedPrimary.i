...
[Mesh]
  ...
  []
  [combined_powder_punch_right]
    type = SideSetsFromBoundingBoxGenerator
    input = uncovered_top_punch_right
    bottom_left = '${fparse punch_radius - 1.0e-3} ${fparse ram_cc_sinter_spacers_height  + sinter_spacer_overhang_height + 1.0e-4} 0.0'
    top_right = '${fparse punch_radius + 1.0e-3} ${fparse stack_with_powder + ram_cc_sinter_punch_height - ram_cc_spacers_height - sinter_spacer_overhang_height - 1.0e-4} 0.0'
    boundary_new = 'combined_powder_punch_right'
    included_boundaries = 'top_punch_right powder_right bottom_punch_right'
  []
...
[Variables]
  ...
  # [temperature_inside_die_wall_lm]
  #   block = 'inside_die_secondary_subdomain'
  #   # initial_condition = 300.0
  #   order = SECOND
  # []
  # [potential_inside_die_wall_lm]
  #   block = 'inside_d_secondary_subdomain'
  #   order = SECOND
  # []
...
#              top_sinter_cc_secondary_subdomain top_cc_ram_secondary_subdomain inside_die_secondary_subdomain'
...
[BCs]
  ...
  # [temperature_top_ram]
  #   type = ADDirichletBC #ADFunctionDirichletBC
  #   variable = temperature
  #   value = 300.0
  #   boundary = 'top_ram_spacer_top'
  # []
...
[Contact]
  ...
  [inside_powder_punch]
    secondary = die_wall_left
    primary = combined_powder_punch_right
    model = frictionless
...
#     gap_flux_models = 'thermal_conduction_wall_top_punch '
#     extra_vector_tags = 'ref'
#     # correct_edge_dropping = true
#     use_displaced_mesh = true
#   []
...
#   #   gap_flux_models = 'electrical_conduction_wall_top_punch'
#   #   extra_vector_tags = 'ref'
#   #   # correct_edge_dropping = true
#   #   use_displaced_mesh = true
#   # []
...
[Materials]
  ...
  #            inside_die_secondary_subdomain'
...
#     temperature = temperature
#     contact_pressure = interface_normal_lm #bottom_ram_cc_normal_lm
...
#     temperature = temperature
#     contact_pressure = interface_normal_lm #bottom_cc_sinter_normal_lm
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = interface_normal_lm #bottom_sinter_punch_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
#     temperature = temperature
#     contact_pressure = interface_normal_lm #bottom_punch_powder_normal_lm
#     primary_hardness = graphite_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = interface_normal_lm #powder_top_punch_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = iron_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = interface_normal_lm #top_punch_sinter_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
#     secondary_conductivity = ccfiber_thermal_conductivity
#     temperature = temperature
#     contact_pressure = interface_normal_lm #top_sinter_cc_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = ccfiber_hardness
...
#     secondary_conductivity = graphite_thermal_conductivity
#     temperature = temperature
#     contact_pressure = interface_normal_lm #top_cc_ram_normal_lm
#     primary_hardness = graphite_hardness
#     secondary_hardness = graphite_hardness
...
[Executioner]
  ...
  nl_rel_tol = 2.9e-4 #1e-6 #1e-8 couldn't converge with 1e-3 dt in the first timestep in 20 nl iterations
  nl_abs_tol = 2e-9 # couldn't converge past the first timestep on temperature #1e-10
  nl_max_its = 20
  nl_forced_its = 2
  l_max_its = 50
