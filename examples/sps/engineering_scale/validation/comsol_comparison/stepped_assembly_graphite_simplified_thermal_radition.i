...
#     expression = 'boltzmann*epsilon*(temperature_farfield^4-temperature^4)'
#   []
...
[BCs]
  ...
  #   boundary = 'exterior_surface'  #all of the external vertical surfaces
  #   variable = temperature
  ...
  #   ## specific to the DCS-5 geometry
  ...
  [top_pressure_ydirection]
    ...
    variable = disp_y
    boundary = 'upper_ram_spacer_top'
    function = 'if(t<10, 2.07e6*t, 20.7e6)'
  []
[]

[Contact]
  [die_wall_plunger_interface]
    primary = 'die_wall_inside'
    secondary = 'contacting_plunger_step_exterior'
    model = frictionless
    c_normal = 1e8
    ...
    use_dual = true
  []
  [plunger_working_surface_interface]
    primary = 'upper_shank_bottom'
    secondary = 'lower_shank_top'
    model = frictionless
    c_normal = 1e8
    # normal_lm_scaling = 1e-6
    formulation = mortar
    ...
    use_dual = true
  []
  [upper_spacer_plunger_interface]
    primary = 'upper_spacer_bottom'
    secondary = 'upper_shank_top'
    model = frictionless
    c_normal = 1e8
    # normal_lm_scaling = 1e-6
    formulation = mortar
    ...
    use_dual = true
  []
  [upper_spacers_interface]
    primary = 'upper_ram_spacer_bottom'
    secondary = 'upper_spacer_top'
    model = frictionless
    c_normal = 1e8
    # normal_lm_scaling = 1e-6
    formulation = mortar
    ...
    use_dual = true
  []
  [lower_spacer_plunger_interface]
    primary = 'lower_shank_bottom'
    secondary = 'lower_spacer_top'
    model = frictionless
    c_normal = 1e8
    # normal_lm_scaling = 1e-6
    formulation = mortar
    ...
    use_dual = true
  []
  [lower_spacers_interface]
    primary = 'lower_space_bottom'  ## should probably fix this in the journal file
    secondary = 'lower_ram_spacer_top'
    model = frictionless
    c_normal = 1e8
    # normal_lm_scaling = 1e-6
    formulation = mortar
...
[Materials]
  ...
  #   coupled_variables = 'temperature'
  #   expression = 'if(temperature > 273.0, '
