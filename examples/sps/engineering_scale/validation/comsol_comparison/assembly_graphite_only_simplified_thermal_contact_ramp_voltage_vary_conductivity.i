...
[Mesh]
  ...
  []
  # [upper_stopper_secondary]
  #   type = LowerDBlockFromSidesetGenerator
  #   sidesets = 'upper_stopper_top'
  #   new_block_id = 2022
  #   new_block_name = 'upper_stopper_secondary'
  #   input = upper_spacer_secondary
  # []
  ...
  []
  # [lower_stopper_secondary]
  #   type = LowerDBlockFromSidesetGenerator
  #   sidesets = 'lower_stopper_bottom'
  #   new_block_id = 2032
  #   new_block_name = 'lower_stopper_secondary'
  #   input = lower_spacer_secondary
  # []
  coord_type = RZ
...
[Variables]
  ...
  []
  # [temperature_upper_stopper_lm]
  #   block = 'upper_stopper_secondary'
  # []
  # [temperature_lower_stopper_lm]
  #   block = 'lower_stopper_secondary'
  # []
[]
