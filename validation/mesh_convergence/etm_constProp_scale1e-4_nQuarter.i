...
ram_spacer_overhang_radius = 0.0062 ## which is less than the actual 0.01 and is implemented to help with meshing and to minimize node alignment at corners of blocks
                                    ## adjusted for this particularly coarse mesh case
...
sinter_spacer_overhang_radius = 0.012 ## is less than the 13.55 that actually exists but the modification is necessary to get the mesh to work
                                      ## adjusted for this particularly coarse mesh case
...
[Mesh]
  ...
  [bottom_ram_overhang]
    type = GeneratedMeshGenerator
    dim = 2
    nx = 1 #extra coarse for this coarse mesh
    ny = 1
  ...
  [bottom_sinter_spacer]
    type = GeneratedMeshGenerator
    dim = 2
    nx = 5  #more coarse--should have been 6 or 7--to accomodate mesh stitching
    ny = 7  #(n+1)/4
  ...
  [bottom_sinter_overhang]
    type = GeneratedMeshGenerator
    dim = 2
    nx = 3  #more coarse--should have been 4 or 5--to accomodate mesh stitching
    ny = 1
...
[Executioner]
  ...
  # start_time = 90
  dtmax = 1.0  ##remember to change back to 1.0
  dtmin = 1.0e-8
  end_time = 1600
  [TimeStepper]
